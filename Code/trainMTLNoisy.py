...
from model_split import DeepSpeech, supported_rnns, NoiseClassifier
...
parser.add_argument('--mtl-lambda', default =0.5, type=float)
...
#    pdb.set_trace()
    ...
    [model, noise_model], optimizer = amp.initialize([model, noise_model], optimizer,
...
#            pdb.set_trace()
            ...
            #loss = loss_noise
            loss = (1 - args.mtl_lambda)*loss + args.mtl_lambda*args.scale*loss_noise
            if args.distributed:
                loss = loss.to(device)
            ...
            del loss, out, float_out, loss_noise, noise_out, float_noise
        ...
        with torch.no_grad():
            ...
            wer, cer, output_data, eval_accuracy = evaluate(test_loader=test_loader,
                                             ...
                                             ifNoiseClassifier=True,
                                             noise_model = noise_model, rnn_split=args.rnn_split)
